<?php
    ...
    /*$pew_db = new Pew_Data_Base("www.efectusdigital.com.br", "efectus_rogerio", "efectusRogerio@123", "efectus_reidasfechaduras", "pew_banners", "pew_categorias", "pew_subcategorias", "pew_contatos", "pew_usuarios_administrativos");*/
    $pew_db = new Pew_Data_Base("localhost", "root", "", "pew_reidasfechaduras", "pew_banners", "pew_categorias", "pew_subcategorias", "pew_contatos", "pew_usuarios_administrativos");
    ...
    if(!class_exists("Pew_Custom_Data_Base")){
        class Pew_Custom_Data_Base{
            ...
            public $tabela_pedidos_orcamentos;
            public $tabela_pedidos_produtos;
            ...
            function __construct($tb_produtos, $tb_marcas, $tb_marcas_produtos, $tb_cores_produtos, $tb_imagens_produtos, $tb_departamentos, $tb_departamentos_produtos, $tb_categorias_produtos, $tb_subcategorias_produtos, $tb_orcamentos, $tb_config_orcamentos, $tb_pedidos_orcamentos, $tb_pedidos_produtos, $tb_categorias_vitrine, $tb_categoria_destaque, $tb_especificacoes, $tb_especificacoes_produtos, $tb_produtos_relacionados){
                ...
                $this->tabela_pedidos_orcamentos = $tb_pedidos_orcamentos;
                $this->tabela_pedidos_produtos = $tb_pedidos_produtos;
    ...
    $pew_custom_db = new Pew_Custom_Data_Base("pew_produtos", "pew_marcas", "pew_marcas_produtos", "pew_cores_produtos", "pew_imagens_produtos", "pew_departamentos", "pew_departamentos_produtos", "pew_categorias_produtos", "pew_subcategorias_produtos", "pew_orcamentos", "pew_config_orcamentos", "pew_pedidos_orcamentos", "pew_pedidos_produtos", "pew_categorias_vitrine", "pew_categoria_destaque", "pew_especificacoes_tecnicas", "pew_especificacoes_produtos", "pew_produtos_relacionados");
