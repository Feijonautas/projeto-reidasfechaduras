<?php
    $post_fields = array("sku", "nome", "marca", "preco", "estoque", "estoque_baixo", "tempo_fabricacao", "descricao_curta", "descricao_longa", "peso", "comprimento", "largura", "altura", "status");
    ...
    if($gravar){
        ...
        $precoPromocaoProduto = $_POST["precoPromocao"];
        ...
        $statusPromocao = intval($_POST["statusPromocao"]) == 1 ? 1 : 0;
        /*END POST DATA*/
