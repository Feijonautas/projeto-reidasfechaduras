<?php
    $post_fields = array("id_produto", "sku", "nome", "marca", "preco", "estoque", "estoque_baixo", "tempo_fabricacao", "descricao_curta", "descricao_longa", "peso", "comprimento", "largura", "altura", "status");
    $file_fields = array();
    ...
    if($gravar){
        ...
        $precoPromocaProduto = $_POST["precoPromocao"];
        $precoProduto = pew_number_format($precoProduto);
        $precoPromocaProduto = pew_number_format($precoPromocaProduto);
        ...
        $statusPromocaoProduto = intval($_POST["statusPromocao"]) == 1 ? 1 : 0;
        /*END POST DATA*/
        ...
        if($nomeProduto != ""){
            ...
            mysqli_query($conexao, "update $tabela_produtos set sku = '$skuProduto', nome = '$nomeProduto', marca = '$marcaProduto', preco = '$precoProduto', preco_promocao = '$precoPromocaProduto', promocao_ativa = '$statusPromocaoProduto', estoque = '$estoqueProduto', estoque_baixo = '$estoqueBaixoProduto', tempo_fabricacao = '$tempoFabricacaoProduto', descricao_curta = '$descricaoCurtaProduto', descricao_longa = '$descricaoLongaProduto', peso = '$pesoProduto', comprimento = '$comprimentoProduto', largura = '$larguraProduto', altura = '$alturaProduto', data = '$dataAtual', status = '$statusProduto' where id = '$idProduto'");
